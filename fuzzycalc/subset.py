<<<<<<< HEAD:fuzzycalc/subset.py
﻿# -*- coding: UTF-8 -*-

from .common import ACCURACY, PRECISION
...
class Subset(object):
    ...
    tnorm=MinMax()
    def __init__(self, begin=0.0, end=1.0, domain=RationalRange(), tnorm=MinMax):
        self.begin=begin
        self.end=end
        self.Domain=domain
        self.Values={}
...
class Interval (Subset):
    ...
    b=0.0
    tnorm=MinMax()
    def __init__(self, a, b, tnorm=MinMax):
        self.a=float(a)
        self.b=float(b)
...
if __name__ == "__main__":
    ...
    #~ doctest.testmod(verbose=False)
    doctest.testmod(verbose=True)
>>>>>>> b73358cc032a051bf476e070f4954c88958ee81c:FuzzyCalc/FuzzySubset.py
